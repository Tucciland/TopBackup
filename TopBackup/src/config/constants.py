...
# Timeout para backups órfãos (em horas)
# Backups com STATUS='E' por mais tempo que isso são considerados "travados"
# e serão marcados como falha na inicialização do app
ORPHAN_BACKUP_TIMEOUT_HOURS = 2
